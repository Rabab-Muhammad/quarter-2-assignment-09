  ...
  return (
    <div className='flex justify-between items-center p-5 bg-blue-950    text-gray-200 px-5 sticky top-0 z-20'>
      <div className='text-3xl font-bold'>Data Fetching</div>
        ...
        <Link href={"/"} onClick={closeMenu} className="transform transition duration-300 hover:scale-105">
          Home
        </Link>
        <Link href={"/client-side"} onClick={closeMenu} className="transform transition duration-300 hover:scale-105">
         Client-Side
        </Link>
        <Link href={"/server-side"} onClick={closeMenu} className="transform transition duration-300 hover:scale-110">
          Server-Side
        </Link>
